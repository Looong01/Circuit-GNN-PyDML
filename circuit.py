...
if __name__ == '__main__':
    ...
    for i in range(100):
        ...
        #如果文件夹不存在则创建
        if not os.path.exists(f'filters/{args.num_resonator}'):
            os.makedirs(f'filters/{args.num_resonator}')
        plt.savefig(f'filters/{args.num_resonator}/Resonator (type {tp}).png')
